...
# Creating prebuilt for dependency: beatsaber-hook - version: 0.8.0
include $(CLEAR_VARS)
...
include $(CLEAR_VARS)
LOCAL_MODULE := rumblerumblequest_1_0_0
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -DVERSION='"1.0.0"' -DID='"rumblerumblequest"' -isystem 'extern/libil2cpp/il2cpp/libil2cpp' -I'./shared' -I './include' -I'./extern' -I'./extern/beatsaber-hook/shared' -I'./extern/modloader/shared' -I'./extern/questui/shared' -I'./extern/custom-types/shared' -I'./extern/codegen/include'
